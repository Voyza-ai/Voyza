...
| **Rail Europe** | EU rail incl. Italy — 200+ operators | Form: agent.raileurope.com/agency-registration | — | 📝 draft ready | Submit form ([field answers](RAIL_API_APPLICATIONS.md#2-rail-europe--agency-registration-form)) |
